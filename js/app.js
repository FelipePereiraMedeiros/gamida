      ...
      function switchTab(tabName) {
        ...
        tabs.forEach((t) => {
          ...
          if (btn) {
            if (t === tabName) {
              btn.className =
                "px-4 py-2 rounded-lg text-xs font-bold bg-brand-600 text-white shadow-md transition hover:bg-brand-500 whitespace-nowrap";
            } else {
              btn.className =
                "px-4 py-2 rounded-lg text-xs font-bold bg-slate-800/60 text-slate-300 hover:bg-slate-700 hover:text-white transition whitespace-nowrap";
            }
          }
        });
